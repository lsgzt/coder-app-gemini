...
object AutocompleteEngine {
    ...
    private val pythonCompletions = listOf(
        ...
        // Built-ins
        AutocompleteItem("print", "print() — Output to console", CompletionType.FUNCTION, -1),
        AutocompleteItem("input", "input() — Read from stdin", CompletionType.FUNCTION, -1),
        AutocompleteItem("len", "len() — Length of object", CompletionType.FUNCTION, -1),
        AutocompleteItem("range", "range()", CompletionType.FUNCTION, -1),
        AutocompleteItem("type", "type() — Get type", CompletionType.FUNCTION, -1),
        AutocompleteItem("int", "int() — Convert to integer", CompletionType.CLASS, -1),
        AutocompleteItem("str", "str() — Convert to string", CompletionType.CLASS, -1),
        AutocompleteItem("float", "float() — Convert to float", CompletionType.CLASS, -1),
        AutocompleteItem("bool", "bool() — Convert to boolean", CompletionType.CLASS, -1),
        AutocompleteItem("list", "list() — Create list", CompletionType.CLASS, -1),
        AutocompleteItem("dict", "dict() — Create dictionary", CompletionType.CLASS, -1),
        AutocompleteItem("set", "set() — Create set", CompletionType.CLASS, -1),
        AutocompleteItem("tuple", "tuple() — Create tuple", CompletionType.CLASS, -1),
        AutocompleteItem("enumerate", "enumerate() — Indexed iteration", CompletionType.FUNCTION, -1),
        AutocompleteItem("zip", "zip() — Zip iterables", CompletionType.FUNCTION, -1),
        AutocompleteItem("map", "map()", CompletionType.FUNCTION, -1),
        AutocompleteItem("filter", "filter()", CompletionType.FUNCTION, -1),
        AutocompleteItem("sorted", "sorted()", CompletionType.FUNCTION, -1),
        AutocompleteItem("reversed", "reversed()", CompletionType.FUNCTION, -1),
        AutocompleteItem("any", "any() — True if any element is true", CompletionType.FUNCTION, -1),
        AutocompleteItem("all", "all() — True if all elements are true", CompletionType.FUNCTION, -1),
        AutocompleteItem("max", "max() — Maximum value", CompletionType.FUNCTION, -1),
        AutocompleteItem("min", "min() — Minimum value", CompletionType.FUNCTION, -1),
        AutocompleteItem("sum", "sum() — Sum of values", CompletionType.FUNCTION, -1),
        AutocompleteItem("abs", "abs() — Absolute value", CompletionType.FUNCTION, -1),
        AutocompleteItem("round", "round() — Round number", CompletionType.FUNCTION, -1),
        AutocompleteItem("open", "open() — Open file", CompletionType.FUNCTION, -1),
        AutocompleteItem("isinstance", "isinstance()", CompletionType.FUNCTION, -1),
        AutocompleteItem("super", "super() — Parent class proxy", CompletionType.FUNCTION, -1),
    ...
    private val htmlCompletions = listOf(
        ...
        // Text tags
        AutocompleteItem("h1", "<h1></h1> — Heading 1", CompletionType.TAG, -5),
        AutocompleteItem("h2", "<h2></h2> — Heading 2", CompletionType.TAG, -5),
        AutocompleteItem("h3", "<h3></h3> — Heading 3", CompletionType.TAG, -5),
        AutocompleteItem("h4", "<h4></h4> — Heading 4", CompletionType.TAG, -5),
        AutocompleteItem("h5", "<h5></h5> — Heading 5", CompletionType.TAG, -5),
        AutocompleteItem("h6", "<h6></h6> — Heading 6", CompletionType.TAG, -5),
        AutocompleteItem("p", "<p></p> — Paragraph", CompletionType.TAG, -4),
        AutocompleteItem("strong", "<strong></strong> — Bold", CompletionType.TAG, -9),
        AutocompleteItem("em", "<em></em> — Italic", CompletionType.TAG, -5),
        AutocompleteItem("br", "<br> — Line break", CompletionType.TAG),
        AutocompleteItem("hr", "<hr> — Horizontal rule", CompletionType.TAG),
        AutocompleteItem("code", "<code></code> — Inline code", CompletionType.TAG, -7),
        AutocompleteItem("pre", "<pre></pre> — Preformatted", CompletionType.TAG, -6),
        AutocompleteItem("blockquote", "<blockquote></blockquote>", CompletionType.TAG, -13),
        // Lists
        AutocompleteItem("ul", "<ul>\n    \n</ul> — Unordered list", CompletionType.TAG, -6),
        AutocompleteItem("ol", "<ol>\n    \n</ol> — Ordered list", CompletionType.TAG, -6),
        AutocompleteItem("li", "<li></li> — List item", CompletionType.TAG, -5),
        AutocompleteItem("dl", "<dl>\n    \n</dl> — Description list", CompletionType.TAG, -6),
        AutocompleteItem("dt", "<dt></dt> — Description term", CompletionType.TAG, -5),
        AutocompleteItem("dd", "<dd></dd> — Description detail", CompletionType.TAG, -5),
        // Links & media
        AutocompleteItem("a", "<a href=\"\"></a> — Link", CompletionType.TAG, -6),
        AutocompleteItem("img", "<img src=\"\" alt=\"\"> — Image", CompletionType.TAG, -9),
        AutocompleteItem("video", "<video src=\"\" controls></video>", CompletionType.TAG, -19),
        AutocompleteItem("audio", "<audio src=\"\" controls></audio>", CompletionType.TAG, -19),
        AutocompleteItem("iframe", "<iframe src=\"\"></iframe>", CompletionType.TAG, -11),
        AutocompleteItem("canvas", "<canvas id=\"\" width=\"\" height=\"\"></canvas>", CompletionType.TAG, -29),
        AutocompleteItem("svg", "<svg viewBox=\"0 0 100 100\">\n    \n</svg>", CompletionType.TAG, -7),
        // Forms
        AutocompleteItem("form", "<form action=\"\" method=\"post\">\n    \n</form>", CompletionType.TAG, -8),
        AutocompleteItem("input", "<input type=\"text\" name=\"\">", CompletionType.TAG, -2),
        AutocompleteItem("button", "<button type=\"button\"></button>", CompletionType.TAG, -9),
        AutocompleteItem("textarea", "<textarea name=\"\" rows=\"4\"></textarea>", CompletionType.TAG, -11),
        AutocompleteItem("select", "<select name=\"\">\n    \n</select>", CompletionType.TAG, -10),
        AutocompleteItem("option", "<option value=\"\"></option>", CompletionType.TAG, -9),
        AutocompleteItem("label", "<label for=\"\"></label>", CompletionType.TAG, -8),
        AutocompleteItem("fieldset", "<fieldset>\n    \n</fieldset>", CompletionType.TAG, -12),
        AutocompleteItem("legend", "<legend></legend>", CompletionType.TAG, -9),
        // Table
        AutocompleteItem("table", "<table>\n    \n</table>", CompletionType.TAG, -9),
        AutocompleteItem("thead", "<thead>\n    \n</thead>", CompletionType.TAG, -9),
        AutocompleteItem("tbody", "<tbody>\n    \n</tbody>", CompletionType.TAG, -9),
        AutocompleteItem("tr", "<tr>\n    \n</tr> — Table row", CompletionType.TAG, -6),
        AutocompleteItem("th", "<th></th> — Table header", CompletionType.TAG, -5),
        AutocompleteItem("td", "<td></td> — Table data", CompletionType.TAG, -5),
        // Meta
        AutocompleteItem("meta", "<meta name=\"\" content=\"\">", CompletionType.TAG, -14),
        AutocompleteItem("link", "<link rel=\"stylesheet\" href=\"\">", CompletionType.TAG, -2),
        AutocompleteItem("script", "<script>\n    \n</script>", CompletionType.TAG, -10),
        AutocompleteItem("style", "<style>\n    \n</style>", CompletionType.TAG, -9),
        AutocompleteItem("title", "<title></title>", CompletionType.TAG, -8),
        // Attributes
